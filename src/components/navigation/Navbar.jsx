const Navbar = () => {
    return (
        <div className="fixed h-20 w-full bg-gray-300">
            <form className="w-1/4 h-12 my-4 flex">
                <input type="text" placeholder="search" className="h-full w-full bg-gray-200 rounded-l-full my-auto pl-4"/>
                <button type="submit" className="h-full w-20 rounded-r-full bg-gray-400 pl-4">
